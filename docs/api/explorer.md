...
const specs = {
  ...
  identity: {
    ...
    url: 'https://raw.githubusercontent.com/neptune-ly/openwave-spec/main/openwave-identity-v1.0.yaml',
  },
  interconnect: {
    label: 'Gateway Interconnect',
    url: 'https://raw.githubusercontent.com/neptune-ly/openwave-spec/main/openwave-gateway-interconnect-v1.yaml',
  },
}
